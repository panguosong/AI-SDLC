...
# Env:
#   AI_SDLC_PACKAGE_SPEC=git+https://github.com/sinclairpan0720/Ai_AutoSDLC.git@v3.2.0   optional published package spec for pip install
#   PYTHON=/path/to/python3.11            optional interpreter override

set -euo pipefail

PACKAGE_SPEC="${AI_SDLC_PACKAGE_SPEC:-git+https://github.com/sinclairpan0720/Ai_AutoSDLC.git@v3.2.0}"
ADD_TO_PATH=0
